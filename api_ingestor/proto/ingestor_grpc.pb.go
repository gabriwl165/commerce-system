...
const (
	UsageService_Consume_FullMethodName = "/yourpackage.UsageService/Consume"
)
...
type UsageServiceClient interface {
	Consume(ctx context.Context, in *UsageInfoRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *usageServiceClient) Consume(ctx context.Context, in *UsageInfoRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, UsageService_Consume_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsageServiceServer interface {
	Consume(context.Context, *UsageInfoRequest) (*empty.Empty, error)
...
func (UnimplementedUsageServiceServer) Consume(context.Context, *UsageInfoRequest) (*empty.Empty, error) {
...
func _UsageService_Consume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UsageInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsageServiceServer).Consume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UsageService_Consume_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsageServiceServer).Consume(ctx, req.(*UsageInfoRequest))
	}
...
var UsageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yourpackage.UsageService",
	HandlerType: (*UsageServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Consume",
			Handler:    _UsageService_Consume_Handler,
		},
	},
